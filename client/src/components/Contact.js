		...
		<section id="contact" className="relative bg-indigo-800">
			<div className="container  px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
				<form className="lg:w-1/2 sm:w-100 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 mx-10" ref={form} onSubmit={sendEmail}>
					...
					<p className="leading-relaxed mb-5">Tell me about your project</p>
				...
				<div className="lg:w-1/2 md:w-1/2 sm: w-100 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-center justify-center relative">
					<div className="relative flex flex-wrap py-6 ">
						<div className=" px-6 mt-4 lg:mt-0">      
							<h2 className="title-font text-white tracking-widest text-s mt-4">EMAIL</h2>             
							<a href="mailto:e.chugreeva@gmail.com " target="_blank" rel="noreferrer"><img className="sm:w-72 md:w-60 s:mt-2" src={emailimg}></img></a>
							...
							<h2 className="title-font  text-white tracking-widest text-s mt-4">ADDRESS</h2>
							<p className="mt-1 font-semibold text-xl">Tel Aviv, Israel</p>
							<div className="flex flex-wrap">
								<a className="title-font font-semibold text-white tracking-widest text-s mt-4 inline-flex" href="https://github.com/echugreeva" target="_blank" rel="noreferrer"><BsGithub className="hover:text-pink-500 w-7 h-7 " /></a>
								<a className="title-font font-semibold text-white tracking-widest text-s mt-4" href="https://www.linkedin.com/in/elena-chugreeva-45b282103/" target="_blank" rel="noreferrer"><BsLinkedin className="hover:text-pink-500 w-7 h-7 ml-4" /></a>
							</div>
						</div>
					</div>
				</div>
