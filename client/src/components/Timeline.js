                            ...
                            <div className="md:flex flex-start">
                                ...
                                <div className="block-inline p-6 rounded-lg shadow-lg bg-gray-100 max-w-md ml-6 mb-10 w-80">
                                    <div className="flex justify-between mb-4">
                                        ...
                                        <p href="#!" className="font-medium text-pink-900 hover:text-pink-700 focus:text-pink-800 duration-300 transition ease-in-out text-sm">2023-present</p>
                                    </div>
                                    <p className="text-gray-700 mb-6">Full Stack Developer</p>
                        ...
                        <li className="min-w-50">
                            <div className="md:flex flex-start">
                                ...
                                <div className="block-inline p-6 rounded-lg shadow-lg bg-gray-100 max-w-md ml-6 mb-10 w-80">
                                    ...
                                    <p className="text-gray-700 mb-6">Full Stack (React/Node JS) Developer</p>
                        ...
                        <li>
                            <div className="md:flex flex-start">
                                ...
                                <div className="block-inline p-6 rounded-lg shadow-lg bg-gray-100 max-w-md ml-6 mb-10 w-80">
                                    <div className="flex justify-between mb-4">
                                        <p href="#!" className="font-medium text-pink-900 hover:text-pink-700 focus:text-pink-800 duration-300 transition ease-in-out text-sm">Web creation software</p>
                                        <p href="#!" className="font-medium text-pink-900 hover:text-pink-700 focus:text-pink-800 duration-300 transition ease-in-out text-sm">2020-2024</p>
                                    </div>
